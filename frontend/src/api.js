...
export const createSuperannuationAccount = (data) => api.post('/superannuation/', data);
...
export const createETFTransaction = (data) => api.post('/etf-transactions/', data);
export const updateETFTransaction = (id, data) => api.put(`/etf-transactions/${id}/`, data);
export const deleteETFTransaction = (id) => api.delete(`/etf-transactions/${id}/`);
...
export const getCryptoPrice = (coingeckoId) => api.get('/crypto/get-price/', { params: { coingecko_id: coingeckoId } });

// Crypto Transactions
export const getCryptoTransactions = (cryptoId) => api.get(`/crypto-transactions/${cryptoId ? `?crypto=${cryptoId}` : ''}`);
export const createCryptoTransaction = (data) => api.post('/crypto-transactions/', data);
export const updateCryptoTransaction = (id, data) => api.put(`/crypto-transactions/${id}/`, data);
export const deleteCryptoTransaction = (id) => api.delete(`/crypto-transactions/${id}/`);
