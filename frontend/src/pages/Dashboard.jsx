...
export default function Dashboard() {
  ...
  const pieData = [
    { name: 'Bank Accounts', value: parseFloat(breakdown.bank_accounts?.total || 0) },
    { name: 'Superannuation', value: parseFloat(breakdown.superannuation?.total || 0) },
        ...
        <CardBody>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold mt-2">{formatCurrency(totalNetworth)}</p>
              <p className="text-blue-100 text-sm mt-2">Australian Dollars (AUD)</p>
            </div>
          ...
          <CardBody>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className={`text-xl font-semibold ${
                  getGainLossColor(investmentSummary.total_unrealised_gain || 0)
                }`}>
                ...
                <CardBody>
                  ...
                  <div className="mt-4">
                    ...
                    {asset.gain !== undefined && (
                      <p className={`text-sm mt-1 ${getGainLossColor(asset.gain)}`}>
