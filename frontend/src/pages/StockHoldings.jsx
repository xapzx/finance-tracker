...
export default function StockHoldings() {
  ...
  const fetchTransactions = async stockId => {
    try {
      const response = await getStockTransactions(stockId);
  ...
  const handleHoldingSubmit = async e => {
    ...
    try {
      ...
      if (editingHolding) {
        await updateStockHolding(editingHolding.id, data);
      } else {
  ...
  return (
    <div className='p-8'>
      <div className='flex items-center justify-between mb-8'>
        <div>
          ...
          <p className='text-gray-500 mt-1'>
            Track your stock investments and dividends
          </p>
        </div>
      ...
      {/* Summary Card */}
      <Card className='mb-8 bg-gradient-to-r from-pink-500 to-pink-600 text-white'>
        <CardBody>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-4'>
              ...
              <div>
                <p className='text-pink-100 text-sm'>Total Market Value</p>
            ...
            <div className='text-right'>
              <p className='text-pink-100 text-sm'>Cost Basis</p>
      ...
      <Modal
        ...
        title={editingHolding ? 'Edit Stock Holding' : 'Add Stock Holding'}
      >
        <form onSubmit={handleHoldingSubmit} className='space-y-4'>
          ...
          <div className='flex gap-3 pt-4'>
            ...
            <Button type='submit' disabled={saving}>
              {saving ? 'Saving...' : editingHolding ? 'Update' : 'Add Stock'}
            </Button>
          </div>
        </form>
      </Modal>
