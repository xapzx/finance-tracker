...
import { Settings as SettingsIcon, User, Lock, Globe, Check, MapPin } from 'lucide-react';
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Date of birth and address</p>
              </div>
            </div>
          </CardHeader>
          <CardBody>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Set your currency and timezone</p>
              </div>
            </div>
          </CardHeader>
          <CardBody>
