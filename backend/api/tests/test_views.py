...
class TestBankAccountViews:
    ...
    def test_create_bank_account(self, auth_client):
        ...
        response = auth_client.post('/api/bank-accounts/', {
            'name': 'New Account',
            'bank_name': 'New Bank',
...
class TestSuperannuationViews:
    ...
    def test_create_super_account(self, auth_client):
        ...
        response = auth_client.post('/api/superannuation/', {
...
class TestCryptoViews:
    ...
    def test_create_crypto_holding(self, auth_client):
        ...
        response = auth_client.post('/api/crypto-holdings/', {
            'symbol': 'ETH',
            'name': 'Ethereum',
...
class TestNetworthSummary:
    ...
    def test_networth_summary(
        self, auth_client, bank_account, super_account,
        etf_holding, crypto_holding, stock_holding
    ):
