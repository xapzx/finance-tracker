...
router.register(
    r"bank-accounts", views.BankAccountViewSet, basename="bank-account"
)
router.register(
    r"superannuation",
    views.SuperannuationAccountViewSet,
    basename="superannuation",
)
router.register(
    r"super-snapshots",
    views.SuperannuationSnapshotViewSet,
    basename="super-snapshot",
)
router.register(
    r"etf-holdings", views.ETFHoldingViewSet, basename="etf-holding"
)
router.register(
    r"etf-transactions",
    views.ETFTransactionViewSet,
    basename="etf-transaction",
)
router.register(
    r"crypto-holdings", views.CryptoHoldingViewSet, basename="crypto-holding"
)
router.register(
    r"crypto-transactions",
    views.CryptoTransactionViewSet,
    basename="crypto-transaction",
)
router.register(
    r"stock-holdings", views.StockHoldingViewSet, basename="stock-holding"
)
router.register(
...
urlpatterns = [
    ...
    path(
        "etf/refresh-prices/",
        views.refresh_etf_prices,
        name="refresh-etf-prices",
    ),
    path(
        "stock/refresh-prices/",
        views.refresh_stock_prices,
